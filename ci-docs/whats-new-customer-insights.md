...
Kami melancarkan kemas kini berasaskan rantau demi rantau. Oleh itu, rantau tertentu mungkin melihat ciri sebelum orang lain. Kecuali dinyatakan secara berbeza, anda tidak perlu mengambil sebarang tindakan, kami akan mengemas kini apl secara automatik tanpa masa henti.
...
Untuk maklumat lanjut, lihat [Eksport segmen ke MoEngage](export-moengage.md).

### <a name="ssh-support-for-sftp-based-exports"></a>Sokongan SSH untuk eksport berasaskan SFTP

Pilih sama ada anda mahu mengesahkan melalui SSH atau nama pengguna/kata laluan untuk sambungan ke destinasi eksport SFTP.

Untuk maklumat lanjut, lihat [Mengeksport data ke hos SFTP](export-sftp.md).

### <a name="personalize-experiences-with-data-about-known-and-unknown-users"></a>Peribadikan pengalaman dengan data tentang pengguna yang diketahui dan tidak diketahui
...
Untuk maklumat lanjut, lihat [Peribadikan pengalaman anda dengan data tentang pengguna yang diketahui dan tidak diketahui](unknown-to-known.md).
...
Mengimport data dari pelbagai sumber data adalah asas untuk menyatukan data pelanggan anda dalam Dynamics 365 Customer Insights. Kami telah menyemak semula pengalaman pengguna untuk import dan sambungan sumber data. Kemas kini ini bertujuan untuk memudahkan anda menelan data kepada Wawasan Pelanggan.

Untuk maklumat lanjut, lihat [Gambaran keseluruhan sumber data](data-sources.md).

### <a name="export-to-inmobi"></a>Eksport ke InMobi

InMobi membantu jenama memahami, mengenal pasti, melibatkan dan memperoleh pengguna. Anda boleh mengeksport segmen dan data lain ke perkhidmatan InMobi melalui akaun Azure Blob Storage.

Untuk maklumat lanjut, lihat [Mengeksport ke InMobi (pratonton)](export-inmobi.md)

### <a name="lockbox-support-in-customer-insights"></a>Sokongan kotak kunci dalam Wawasan Pelanggan

Kotak Kunci Pelanggan menyediakan antara muka untuk menyemak dan meluluskan (atau menolak) permintaan akses data. Permintaan ini berlaku apabila akses data kepada data pelanggan diperlukan untuk menyelesaikan kes sokongan.

Untuk maklumat lanjut, lihat Akses [data pelanggan secara selamat dengan Peti Kunci Pelanggan (Pratonton)](security-overview.md#securely-access-customer-data-with-customer-lockbox-preview).

### <a name="connect-to-your-data-using-azure-private-link"></a>Sambung ke data anda menggunakan Azure Private Link

Azure Private Link mari kita Wawasan Pelanggan menyambung ke akaun anda Azure Data Lake Storage melalui titik akhir peribadi dalam rangkaian maya anda. Untuk data dalam akaun storan, yang tidak terdedah kepada internet awam, Pautan Peribadi mendayakan sambungan ke rangkaian terhad tersebut.

Untuk maklumat lanjut, lihat [Menggunakan Pautan Peribadi dalam Wawasan](security-overview.md#set-up-an-azure-private-link) Pelanggan.
...
### <a name="updated-data-unification-experience"></a>Pengalaman penyatuan data yang dikemas kini
 ...
 Penyatuan data membolehkan anda menyatukan sumber data yang berbeza sekali ke dalam set data induk tunggal yang menyediakan pandangan bersatu data tersebut. Data boleh disatukan pada entiti tunggal atau berbilang entiti. Mula-mula, anda [memilih entiti dan medan](map-entities.md) sumber, [mengalih keluar rekod](remove-duplicates.md) pendua, menentukan peraturan untuk [syarat](match-entities.md) yang sepadan dan menentukan medan yang [akan disertakan dalam profil](merge-entities.md) pelanggan bersatu.
...
Untuk maklumat lanjut, lihat [Menerokai Wawasan](home.md) Pelanggan.
...
Untuk maklumat lanjut, lihat [Pengayaan profil syarikat dengan Dun & Bradstreet (Pratonton)](enrichment-dnb.md).

### <a name="define-the-measure-type-when-creating-a-new-measure"></a>Mentakrifkan jenis ukuran apabila mencipta ukuran baru

Anda kini boleh membezakan antara langkah-langkah untuk profil individu dan langkah-langkah di seluruh perniagaan anda. Walaupun langkah-langkah perniagaan ditunjukkan di halaman utama Wawasan Pelanggan, langkah-langkah pelanggan terdedah pada pandangan pelanggan yang terperinci.

Untuk maklumat lanjut, lihat [Gunakan pembina ukuran untuk mencipta langkah dari awal](measure-builder.md).

### <a name="consolidation-of-customer-insights-documentation"></a>Penyatuan dokumentasi Wawasan Pelanggan

Kami telah menyemak semula artikel dokumentasi kami dan mengalih keluar sebutan cerapan penglibatan dan keupayaan cerapan khalayak. Melangkah ke hadapan, kami akan merujuk secara konsisten kepada nama produk Wawasan Pelanggan apabila kami menulis tentang ciri teras aplikasi. Perubahan ini juga membawa kepada penstrukturan semula jadual kandungan, struktur URL dan laluan fail dalam repositori dokumentasi asas. Semua penanda buku atau pautan sedia ada anda terus berfungsi dan mengubah hala ke URL yang dikemas kini.

Sekiranya anda ingin memberitahu kami bagaimana anda melihat perubahan itu atau melihat sesuatu yang tidak berfungsi seperti yang [diharapkan, beritahu kami dengan mengemukakan maklum balas untuk halaman ini](https://github.com/MicrosoftDocs/customer-insights/issues/new?title=&body=%0A%0A%5BEnter%20feedback%20here%5D%0A%0A%0A---%0A%23%23%23%23%20Document%20Details%0A%0A%E2%9A%A0%20*Do%20not%20edit%20this%20section.%20It%20is%20required%20for%20docs.microsoft.com%20%E2%9E%9F%20GitHub%20issue%20linking.*%0A%0A*%20ID%3A%20d323ba46-f96e-1972-bc52-9b88f7d9cdfa%0A*%20Version%20Independent%20ID%3A%20d323ba46-f96e-1972-bc52-9b88f7d9cdfa%0A*%20Content%3A%20%5BNew%20and%20upcoming%20features%20-%20Dynamics%20365%20Customer%20Insights%5D(https%3A%2F%2Fdocs.microsoft.com%2Fen-us%2Fdynamics365%2Fcustomer-insights%2Fwhats-new-customer-insights)%0A*%20Content%20Source%3A%20%5Bci-docs%2Fwhats-new-customer-insights.md%5D(https%3A%2F%2Fgithub.com%2FMicrosoftDocs%2Fcustomer-insights%2Fblob%2Fmain%2Fci-docs%2Fwhats-new-customer-insights.md)%0A*%20Service%3A%20**customer-insights**%0A*%20Sub-service%3A%20**audience-insights**%0A*%20GitHub%20Login%3A%20%40m-hartmann%0A*%20Microsoft%20Alias%3A%20**mhart**).
...
### <a name="organize-segments-and-measures-with-tags-and-filters"></a>Susun segmen dan langkah dengan tag dan penapis

Jika organisasi anda mengekalkan banyak segmen atau langkah, mencari yang betul kadangkala boleh berasa mencabar. Ciri baru ini membolehkan anda mengatur senarai menggunakan tag dan lajur. Ia membantu mencari data dengan cepat dan mudah dan menyesuaikan pandangan.

Untuk maklumat lanjut, lihat [Bekerja dengan tag dan lajur](work-with-tags-columns.md).

### <a name="enable-data-sharing-with-dataverse-when-using-your-own-storage-account"></a>Dayakan perkongsian data apabila Dataverse menggunakan akaun storan anda sendiri

Jika persekitaran anda digunakan Azure Data Lake Storage untuk menyimpan data Wawasan Pelanggan, perkongsian data memerlukan Microsoft Dataverse beberapa konfigurasi tambahan.
Sebelum ini, anda hanya boleh mendayakan perkongsian Dataverse data apabila data anda disimpan dalam tasik data terurus kami.
...
Untuk maklumat lanjut, lihat [Mengeksport segmen ke Iterable (pratonton)](export-iterable.md) dan [Eksport segmen ke Braze (pratonton)](export-braze.md).
...
### <a name="new-data-source-integration-with-azure-synapse-analytics-preview"></a>Sumber data Baru: Integrasi dengan Azure Synapse Analytics (Pratonton)

Azure Synapse Analytics ialah perkhidmatan analisis perusahaan yang mempercepatkan masa untuk cerapan merentasi gudang data dan sistem data besar.
...
Gunakan data daripada sumber seperti Microsoft dan rakan kongsi lain untuk memperkayakan data pelanggan anda sebelum penyatuan data. Pengayaan sumber data membantu menghasilkan kesempurnaan dan kualiti data yang lebih tinggi yang dapat membantu mencapai hasil yang lebih baik sebaik sahaja anda menyatukan data anda.
...
Walaupun sesetengah pengguna boleh mempunyai keizinan pentadbir dalam Wawasan Pelanggan, hanya seorang pengguna adalah pemilik persekitaran. Pengalaman yang lebih baik membolehkan anda menukar pemilik persekitaran dan menuntut pemilikan jika bekas pemilik meninggalkan organisasi. 
...
Penyediaan data sekarang menunjukkan sebab rasuah untuk semua medan dengan data yang rosak. Maklumat ini disediakan di peringkat rekod individu untuk pengenalan mudah. 

Untuk maklumat lanjut, lihat [Sumber](entities.md#corrupted-data-sources) data yang rosak.

### <a name="end-of-preview-for-reporting-features-in-the-engagement-insights-capability"></a>Penghujung pratonton untuk ciri pelaporan dalam keupayaan cerapan penglibatan

Pratonton Dynamics 365 Customer Insights keupayaan cerapan penglibatan berakhir pada 15 Februari 2022.  
Perubahan ini bermaksud pengalaman percubaan Wawasan Pelanggan tidak lagi merangkumi kemampuan untuk membuat corong atau fungsi pelaporan lain.

Kami menjemput anda untuk meneroka dan menilai banyak ciri lain Wawasan [Pelanggan](https://dynamics.microsoft.com/ai/customer-insights/), platform data pelanggan Microsoft (CDP).    
...
Semasa tempoh peralihan, peristiwa yang ditangkap masih disiarkan ke Tasik Data yang bersambung. Setelah fungsi ini dimatikan, perkongsian data akan berhenti dan tiada peristiwa baru dihantar ke storan yang disambungkan.
Hubungi pasukan Akaun Microsoft anda secara langsung jika anda mempunyai soalan tentang penghujung pratonton keupayaan. Pasukan Akaun anda akan memastikan anda sentiasa terkini mengenai pelancaran yang akan datang. 
...
Wawasan Pelanggan menyediakan ciri berkuasa AI baharu untuk mensintesis sentimen pelanggan dan mengenal pasti aspek perniagaan tertentu sebagai peluang untuk penambahbaikan yang disasarkan. Dengan menganalisis maklum balas bertulis pelanggan anda, anda boleh mendapatkan pandangan yang tepat pada kos rendah. Analisis sentimen yang dikuasakan oleh model Pemprosesan Bahasa Asli (NLP) yang menjana dua cerapan yang diperolehi untuk setiap ID pelanggan. Skor sentimen (daripada -5 hingga 5) dan senarai aspek perniagaan yang berkenaan. 
