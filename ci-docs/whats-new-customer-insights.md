...
### <a name="dun--bradstreet-enrichment-preview"></a>Pengayaan Dun & Bradstreet (Preview)
...
Anda kini boleh membezakan antara langkah-langkah untuk profil individu dan langkah-langkah di seluruh perniagaan anda. Walaupun langkah-langkah perniagaan dipaparkan di halaman utama Wawasan Pelanggan, langkah-langkah pelanggan terdedah pada pandangan pelanggan yang terperinci.

Untuk maklumat lanjut, lihat [Menggunakan pembangun ukuran untuk mencipta langkah dari awal](measure-builder.md).
