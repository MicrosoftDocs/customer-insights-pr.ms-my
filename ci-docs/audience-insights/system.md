...
ms.locfileid: "8354244"
---
# <a name="system-configuration"></a>Konfigurasi sistem

Untuk mencapai konfigurasi sistem dalam wawasan khalayak, dari bar navigasi kiri pilih **AdminSystem** > **untuk** melihat senarai tugas dan proses sistem.
...
Tab **Status** membolehkan anda menjejak kemajuan tugas, pengingesan data, eksport data dan beberapa proses produk penting yang lain. Semak maklumat pada tab ini untuk memastikan kesempurnaan tugas dan proses aktif anda.
...
|Berjaya  |Tugas atau proses berjaya diselesaikan. Untuk sumber data, menunjukkan data telah berjaya ditelan jika masa disebut dalam **lajur Disegar semula**.|
|Dibaris | Pemprosesan dibaris gilir dan akan bermula sebaik sahaja semua tugas dan proses huluan selesai. Untuk maklumat lanjut, lihat [Segar semula proses](#refresh-processes).|

### <a name="refresh-processes"></a>Segar semula proses

Segar semula untuk tugas dan proses dijalankan mengikut jadual [yang dikonfigurasi](#schedule-tab). 

|Proses  |Description  |
|---------|---------|
|Aktiviti  |Berjalan secara manual (segar semula masa tunggal). Bergantung pada proses penggabungan. Wawasan bergantung pada pemprosesannya.|
...
|Penyediaan data   |Bergantung pada cantuman.   |
...
|Pengayaan   |Berjalan secara manual (segar semula masa tunggal). Bergantung pada proses penggabungan. |
...
|Langkah  |Berjalan secara manual (segar semula masa tunggal). Bergantung pada proses penggabungan.  |
...
|Profil   |Berjalan secara manual (segar semula masa tunggal). Bergantung pada proses penggabungan. |
|Carian   |Berjalan secara manual (segar semula masa tunggal). Bergantung pada proses penggabungan. |
|Segmen  |Berjalan secara manual (segar semula masa tunggal). Bergantung pada proses penggabungan. Wawasan bergantung pada pemprosesannya.|
...
Pilih status proses untuk melihat butiran kemajuan keseluruhan kerja yang ada. Proses segar semula di atas boleh membantu memahami perkara yang anda boleh lakukan untuk menangani tugas atau proses yang **dilangkau** atau **dibaris gilir**.
...
> [!NOTE]
> Sumber data yang diuruskan oleh anda menyegar semula mengikut jadual mereka sendiri. Untuk menjadualkan segar semula sumber data yang diuruskan oleh anda, konfigurasikan seting segar semula pada sumber data tertentu daripada **halaman Sumber** data.
