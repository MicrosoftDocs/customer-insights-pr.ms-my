...
- **Eksport segmen** membolehkan anda mengeksport entiti segmen daripada Wawasan Pelanggan. Segmen mewakili senarai profil pelanggan. Apabila mengkonfigurasi eksport, anda memilih medan data yang disertakan, bergantung pada sistem sasaran yang anda eksport data kepada. 
